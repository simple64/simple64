...
if [[ ${UNAME} == *"MINGW64"* ]]; then
  ...
  cp -v "${MSYSTEM_PREFIX}/bin/libicuin75.dll" "${install_dir}"
  cp -v "${MSYSTEM_PREFIX}/bin/libicuuc75.dll" "${install_dir}"
  cp -v "${MSYSTEM_PREFIX}/bin/libicudt75.dll" "${install_dir}"
